...
/**
  ...
  * Some other examples could also be found in `sparkz.core.validation.ValidationSpec`.
  *
...
object ModifierValidator {
  ...
  def apply(settings: ValidationSettings)(implicit e: SparkzEncoder): ValidationState[Unit] = {
...
case class ValidationState[T](result: ValidationResult[T], settings: ValidationSettings)(implicit e: SparkzEncoder) {
